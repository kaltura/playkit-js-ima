...
var ImaDecorator = function (_PlayerDecoratorBase) {
  _inherits(ImaDecorator, _PlayerDecoratorBase);

  function ImaDecorator(imaPlugin) {
    _classCallCheck(this, ImaDecorator);

    var _this = _possibleConstructorReturn(this, (ImaDecorator.__proto__ || Object.getPrototypeOf(ImaDecorator)).call(this));

    _this._plugin = imaPlugin;
    return _this;
  }

  _createClass(ImaDecorator, [{
    key: 'load',
    value: function load() {
      var _this2 = this;

      return this._plugin.imaPromise.then(function () {
        _this2._plugin.sdk = window.google.ima;
        _this2._plugin.initIma();
        if (!_this2._plugin.requestAds()) {
          return _get(ImaDecorator.prototype.__proto__ || Object.getPrototypeOf(ImaDecorator.prototype), 'load', _this2).call(_this2).then(function () {
            _this2._plugin.mediaLoaded = true;
            _this2._plugin.canPlayMedia = true;
          });
        }
        _this2._plugin.playerLoaded = true;
      });
    }
  }, {
    key: 'play',
    value: function play() {
      ...
      var promise = new Promise(function (resolve /*, reject */) {
        if (!_this3._plugin.playerLoaded) {
          _this3.load().then(function () {
            // If we don't have any ads - play the content
            if (_this3._plugin.canPlayMedia) {
              _get(ImaDecorator.prototype.__proto__ || Object.getPrototypeOf(ImaDecorator.prototype), 'play', _this3).call(_this3);
            }
            resolve();
          });
        } else {
      ...
      promise.then(function () {
        if (!_this3._plugin.initComplete) {
          _this3._plugin.initialUserAction();
        } else {
          if (_this3._plugin.adsActive) {
            _this3._plugin.adsManager.resume();
          } else {
            _get(ImaDecorator.prototype.__proto__ || Object.getPrototypeOf(ImaDecorator.prototype), 'play', _this3).call(_this3);
          }
        }
    ...
    value: function pause() {
      if (this._plugin.adsActive) {
        ...
        _get(ImaDecorator.prototype.__proto__ || Object.getPrototypeOf(ImaDecorator.prototype), 'pause', this).call(this);
      }
    }
  }]);

  return ImaDecorator;
}(_playkitJs.PlayerDecoratorBase);

exports.default = ImaDecorator;
...
var _imaDecorator = __webpack_require__(1);

var _imaDecorator2 = _interopRequireDefault(_imaDecorator);
...
var ImaPlugin = function (_BasePlugin) {
  _inherits(ImaPlugin, _BasePlugin);

  _createClass(ImaPlugin, null, [{
    key: 'isValid',
    value: function isValid() {
      return true;
    }
  ...
  function ImaPlugin(name, player, config) {
    _classCallCheck(this, ImaPlugin);

    var _this = _possibleConstructorReturn(this, (ImaPlugin.__proto__ || Object.getPrototypeOf(ImaPlugin)).call(this, name, player, config));

    _this.imaPromise = _this._loadScriptAsync(ImaPlugin.IMA_SDK_LIB_URL);
    _this.mediaLoaded = false;
    _this.canPlayMedia = false;
    _this.playerLoaded = false;
    _this.initComplete = false;
    _this.adsActive = false;
    _this._playOnceReady = false;
  ...
  _createClass(ImaPlugin, [{
    ...
    value: function _onAdsManagerLoaded(adsManagerLoadedEvent) {
      ...
      var adsRenderingSettings = new this.sdk.AdsRenderingSettings();
    ...
    value: function _processAdsManager() {
      ...
      var events = [this.sdk.AdEvent.Type.ALL_ADS_COMPLETED, this.sdk.AdEvent.Type.CLICK, this.sdk.AdEvent.Type.COMPLETE, this.sdk.AdEvent.Type.FIRST_QUARTILE, this.sdk.AdEvent.Type.LOADED, this.sdk.AdEvent.Type.MIDPOINT, this.sdk.AdEvent.Type.PAUSED, this.sdk.AdEvent.Type.STARTED, this.sdk.AdEvent.Type.THIRD_QUARTILE];
      var _iteratorNormalCompletion = true;
      var _didIteratorError = false;
      var _iteratorError = undefined;
      ...
      var initWidth = parseInt(getComputedStyle(this.player.getVideoElement()).width, 10);
      var initHeight = parseInt(getComputedStyle(this.player.getVideoElement()).height, 10);
    ...
    key: '_loadScriptAsync',
    value: function _loadScriptAsync(url) {
    ...
    key: 'getPlayerDecorator',
    value: function getPlayerDecorator() {
      return new _imaDecorator2.default(this);
    }
  }, {
    ...
    value: function initialUserAction() {
      ...
      if (this.adsManager) {
        this.adsManager.start();
        if (!this.mediaLoaded) {
          this.player.load().then(function () {
            _this2.mediaLoaded = true;
          });
        }
      } else {
...
ImaPlugin.IMA_SDK_LIB_URL = "//imasdk.googleapis.com/js/sdkloader/ima3_debug.js";


(0, _playkitJs.registerPlugin)(pluginName, ImaPlugin);

/***/ })
/******/ ]);
//# sourceMappingURL=playkit-js-ima.js.map