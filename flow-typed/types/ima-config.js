 ...
 * @param {boolean} [forceReloadMediaAfterAds=false] - Whether browser could play only on one video tag at the time, should force load our media after ads finish.
 * @param {boolean} [delayInitUntilSourceSelected=false] - Whether ima playing on our video tag - we wait until the video tag loaded and then load Ima.
