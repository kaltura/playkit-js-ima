...
<br>To make sure that won't happened, configure `useStyledLinearAds` and set it to `true` before VPAID ad starting to play. This will tell the player to let IMA SDK to handle the UI itself.
